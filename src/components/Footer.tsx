    ...
    <footer className="loan-footer">
      <div className="footer-content">
        ...
        {hasPartnerFooterInfo && (
          <div className="partner-footer-info" dangerouslySetInnerHTML={{ __html: partner!.footer_info! }} />
        )}
        ...
        {!hasPartnerFooterInfo && (
          <div className="footer-legal">
            ...
            <p>
              Tiger Lion Financial Limited is registered in England & Wales under company number <a href="https://find-and-update.company-information.service.gov.uk/company/10189367" target="_blank" rel="noopener noreferrer" className="footer-link">10189367</a>.
            </p>
            ...
            <p>
              FCA Firm Reference Number: <a href="https://register.fca.org.uk/s/firm?id=001b000003RFLpvAAH" target="_blank" rel="noopener noreferrer" className="footer-link">753151</a>
            </p>
            <p>
              Information Commissioner's Office (ICO) Registration Number: <a href="https://ico.org.uk/ESDWebPages/Entry/ZA185613" target="_blank" rel="noopener noreferrer" className="footer-link">ZA185613</a>
            </p>
            <p className="footer-highlight">LoanTube is as a credit broker, not a lender.</p>
            ...
            <p className="footer-warning"><b>Warning:</b> Late repayments can cause serious money problems. For help, visit <a href="https://moneyhelper.org.uk" className="footer-link" target="_blank" rel="noopener noreferrer">moneyhelper.org.uk</a>.</p>
        ...
        <div className="footer-links">
          <a href="https://www.loantube.com/cookies-policy/" target="_blank" rel="noopener noreferrer" className="footer-policy-link">Cookies Policy</a> | 
          <a href="https://www.loantube.com/privacy-policy/" target="_blank" rel="noopener noreferrer" className="footer-policy-link">Privacy Policy</a> | 
          <a href="https://www.loantube.com/terms-and-conditions/" target="_blank" rel="noopener noreferrer" className="footer-policy-link">Terms and Conditions</a> | 
          <a href="https://www.loantube.com/complaints-policy/" target="_blank" rel="noopener noreferrer" className="footer-policy-link">Complaints Policy</a> | 
          <a href="https://www.loantube.com/treating-customers-fairly/" target="_blank" rel="noopener noreferrer" className="footer-policy-link">Treating Customers Fairly</a> |
          <a href="https://www.loantube.com/our-partners/" target="_blank" rel="noopener noreferrer" className="footer-policy-link">Our Partners</a>
        </div>
        ...
        {hasPartnerFooterLinks && (
          <>
            ...
            <div className="footer-links partner-footer-links">
